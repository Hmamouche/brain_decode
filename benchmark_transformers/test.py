...
if __name__ == '__main__':
    ...
    parser.add_argument("--nb_seeds", "-ns", help="Number of seeds. Must the same value used in training", default = 1)
    ...
    for seed in range (0 , args.nb_seeds, 1):
        model = torch.load('trained_models/%s_%s.pt'%(args.model_name, seed), map_location=torch.device(device))

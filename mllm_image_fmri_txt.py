...
from src.Transformer import DeconvBipartiteTransformerConv
...
def save_checkpoint(model, cur_epoch, is_best=False):
    ...
    os.system ("rm trained_models/checkpoint_mllm_image_fmri_txt*")
    save_to = "trained_models/checkpoint_mllm_image_fmri_txt_{}.pth".format("best" if is_best else cur_epoch)
...
def train (model, data_loader, epochs = 100, save_iters = 10):
...
if __name__ == '__main__':
    ...
    train (llm, data_loader["train"], epochs = 200, save_iters = 10)
